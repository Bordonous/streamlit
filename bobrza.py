...
map = folium.Map(location=[bobrza_locations.lat.mean(), bobrza_locations.lon.mean()], zoom_start=12, control_scale=True, zoom_control=True,width=1200,height=600, position="right")
